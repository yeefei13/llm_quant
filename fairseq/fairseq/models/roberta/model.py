    ...
    def forward(
        ...
        **unused,
        ...
        x, extra = self.extract_features(
            src_tokens, num_bits=unused['num_bits'], return_all_hiddens=return_all_hiddens
        )
        if not features_only:
            x = self.output_layer(x, masked_tokens=masked_tokens)
        return x, extra

    def extract_features(self, src_tokens, num_bits,return_all_hiddens=False, **kwargs):
