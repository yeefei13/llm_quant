...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        self.cyclic_num_bits_schedule=[4,32]
        self._iter=0
        self.num_bits=-1
    ...
    def train_step(self, samples,  raise_oom=False):
        ...
        cyclic_period = int(self.cfg.optimization.max_epoch / self.num_cyclic_period)
        cyclic_adjust_precision(self.cyclic_period)
        self._iter+=1
...
def cyclic_adjust_precision(self, cyclic_period):
    ...
    if self._iter % self.eval_every == 0:
